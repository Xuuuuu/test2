...
def getInfo(link, user_agent):
    ...
    # print(positionName,location,salary,companyName,classification,experience,education,hiringNumber,issueDate)
...
try:
    ...
    writer.writerow(("职位名称","职位地址","地区","薪资","公司名称","公司简介","职位信息","职能类别","关键字","公司福利","工作经验","学历","招聘人数","发布时间"))
    print('--------------START--------------')
